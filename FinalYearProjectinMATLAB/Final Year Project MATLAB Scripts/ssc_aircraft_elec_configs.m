...
FlightProfileStruct(1).v0 = 0;                   % Initial airspeed of aircraft in m/s
FlightProfileStruct(1).h0 = 0;                    % Initial height of aircraft in m
FlightProfileStruct(1).FlightProfileHeight = 15;  % Maximum height of aircraft in m
...
FlightProfileStruct(2).v0 = 0;                     % Initial airspeed of aircraft in m/s
FlightProfileStruct(2).h0 = 0;                    % Initial height of aircraft in m
FlightProfileStruct(2).FlightProfileHeight = 76.2;  % Maximum height of aircraft in m
...
FlightProfileStruct(3).v0 = 0;                   % Initial airspeed of aircraft in m/s
FlightProfileStruct(3).h0 = 0;                    % Initial height of aircraft in m
...
FlightProfileStruct(4).v0 = 0;                     % Initial airspeed of aircraft in m/s
FlightProfileStruct(4).h0 = 0;                    % Initial height of aircraft in m
