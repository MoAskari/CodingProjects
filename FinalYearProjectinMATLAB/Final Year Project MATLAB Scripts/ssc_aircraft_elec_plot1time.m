...
simlog_motor = simlog_ssc_aircraft_elec.Brushless_DC_Motor.Electrical_Power.Current_Sensor.I.series.values('A');
simlog_load = simlog_ssc_aircraft_elec.DC_Power_Distribution.Resistor.i.series.values('A');

% Get load power levels
simlog_gps = simlog_ssc_aircraft_elec.GPS.Electrical_Power.PS_Product.O.series.values('W');
simlog_pixhawk = simlog_ssc_aircraft_elec.Pixhawk.Electrical_Power.PS_Product.O.series.values('W');
simlog_servos = simlog_ssc_aircraft_elec.Servos.Electrical_Power.PS_Product.O.series.values('W');
...
plot(simlog_t/60, simlog_gps, 'LineWidth', 1)
hold on
plot(simlog_t/60, simlog_pixhawk, 'LineWidth', 1)
plot(simlog_t/60, simlog_servos, 'LineWidth', 1)
grid on
legend('GPS','Pixhawk','Servos','Location','best')
title('Power Levels')
ylabel('Power (W)')
xlabel('Time (min)')
...
clear simlog_gps simlog_pixhawk simlog_servos
