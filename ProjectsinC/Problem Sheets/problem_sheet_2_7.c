...
/* Write a program to read in 4 marks for each of 10 students from a file "marks.txt"
(create your own file or use the file marks.txt found on Blackboard), and write out
all the marks and the average mark for each student to the screen. Write helpful
text along with the output to the screen, and format the average marks
appropriately. */
