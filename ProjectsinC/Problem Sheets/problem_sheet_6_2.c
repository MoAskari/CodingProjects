...
/*.
2. Modify the program you created for Problem Sheet 5, number 3, to calculate y(x) = Ax2 +
Bx + C using a function with a pointer for y, eg void quadratic(int x, float A,
